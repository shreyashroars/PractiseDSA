class Solution {
    ...
    public int chpick(int r1,int c1,int r2,int [][]mat,int[][][]dp)
    {
        int c2=r1+c1-r2;
        ...
        int path1=chpick(r1,c1+1,r2,mat,dp); //hh
         int path2=chpick(r1,c1+1,r2+1,mat,dp); //hv
         int path3=chpick(r1+1,c1,r2+1,mat,dp); //vv
         int path4=chpick(r1+1,c1,r2,mat,dp); //vh
    ...
    public int cherryPickup(int[][] mat) {
        ...
        return Math.max(0,chpick(0,0,0,mat,dp));
